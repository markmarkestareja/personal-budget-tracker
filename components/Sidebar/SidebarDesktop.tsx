  ...
  return (
    <div className="h-lvh sticky flex flex-col justify-between">
      <div className="flex flex-col gap-12">
        ...
        <div className="px-6 flex flex-col justify-start items-start gap-6 pt-6">
          <button
            className={`flex items-center gap-2 w-full rounded-[8px] transition
              ${pathname === "/"
                ? "bg-primary-muted text-primary p-4"
                : "hover:text-dark/50 pl-4"
              }
              `}
            onClick={() => router.push("/")}
          >
