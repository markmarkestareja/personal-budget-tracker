      ...
      <TableBody>
        {expenses.map((expense, index) => (
          <TableRow key={index}>
            ...
            <TableCell className="p-4">{expense.spent}</TableCell>
            <TableCell className="p-4">{expense.budget}</TableCell>
            <TableCell className="p-4">{expense.budget - expense.spent}</TableCell>
          </TableRow>
        ))}
      </TableBody>
    </Table>
